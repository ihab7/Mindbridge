    ...
    return (
      <div className="rounded-xl border border-border bg-card p-6">
        <div className="flex flex-col items-center gap-2 py-6 text-center">
          ...
          <Button type="button" className="mt-2" onClick={() => setModalOpen(true)}>
    ...
    <div className="rounded-xl border border-border bg-card p-6">
      <div className="mb-1 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-card-foreground">{ANXIETY_PROGRAM.title[locale]}</h2>
          </div>
      ...
      <p className="mb-4 text-sm text-muted-foreground">
        {t("program.practitioner.summaryLine", {
          ...
          total: ANXIETY_PROGRAM.totalSessions,
          streak,
          trend: trendLabel,
        })}
      </p>
